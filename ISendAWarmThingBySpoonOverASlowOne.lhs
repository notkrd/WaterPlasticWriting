...
The noun-phrase as gentle taxonomizer - not fencing but a gesture of a hand. Infinitives as opened windows - to build.
...
i'm looking for a sentence as a jolt or flow or snapping i guess: not just an illegibility but the machine on the (n+1)-th increment just more subtle than this. Wherein leaves split in even halves (a material; not metaphor). Wherein sweetie pie gets me something to eat. Whereby the conducted experiment does not accept late submissions. Fake motority of the regular pebbles, the pressings into steady dirt. 
...
conjugate_NP_DET_Ns = rules_for_cases [
  (Set.fromList ["3rd SING"], Set.fromList ["1st","possession"], Set.fromList ["SING","possession"]),
  (Set.fromList ["3rd PLUR"], Set.fromList ["1st","possession"], Set.fromList ["PLUR","possession"]),
  (Set.fromList ["3nd"], Set.fromList ["2nd", "possession"], Set.fromList ["possession"]),
  (Set.fromList ["3rd SING","located","definite"], Set.fromList ["3rd SING","for SING","locating"], Set.fromList ["SING","complex"]),
  (Set.fromList ["3rd PLUR","located","definite"], Set.fromList ["3rd PLUR","for PLUR","locating"], Set.fromList ["PLUR","complex"]),
  (Set.fromList ["3rd SING","referred","definite"], Set.fromList ["3rd SING","for SING","referring","definite"], Set.fromList ["SING"]),
  (Set.fromList ["3rd PLUR","referred","definite"], Set.fromList ["3rd PLUR","for PLUR","definite"], Set.fromList ["PLUR"]),
  (Set.fromList ["3rd SING","referred","indefinite"], Set.fromList ["3rd SING","for SING","referring","indefinite"], Set.fromList ["SING"]),
  (Set.fromList ["3rd PLUR","referred","indefinite"], Set.fromList ["3rd PLUR","for PLUR","referring","indefinite"], Set.fromList ["PLUR"])
  ]

conjugate_N_ADJ_Ns :: YourGrammar -> YourGrammar
conjugate_N_ADJ_Ns = rules_for_cases [
  (Set.fromList ["SING"], Set.fromList [], Set.fromList ["SING"]),
  (Set.fromList ["PLUR"], Set.fromList [], Set.fromList ["PLUR"])]

conjugate_S_NP_VPs :: YourGrammar -> YourGrammar -- For rules of form S -> NP VP
conjugate_S_NP_VPs = rules_for_cases [
  (Set.singleton "1st SING", Set.singleton "1st SING", Set.fromList ["1st SING"]),
...
conjugate_VP_VT_NPs :: YourGrammar -> YourGrammar -- For rules of form VP -> VT NP
conjugate_VP_VT_NPs = rules_for_cases [
  (Set.singleton "1st SING", Set.singleton "1st SING", Set.fromList ["1st SING","reflexive"]),
  (Set.singleton "1st SING", Set.singleton "1st SING", Set.fromList ["2nd","Obj"]),
  (Set.singleton "1st SING", Set.singleton "1st SING", Set.fromList ["3rd SING","Obj"]),
  (Set.singleton "1st SING", Set.singleton "1st SING", Set.fromList ["3rd PLUR","Obj"]),
  (Set.singleton "2nd",      Set.singleton "2nd",      Set.singleton "Obj"),
  (Set.singleton "3rd SING", Set.singleton "3rd SING", Set.singleton "Obj"),
  (Set.singleton "3rd PLUR", Set.singleton "3rd PLUR", Set.singleton "Obj")]
